...
if ( function_exists( 'add_theme_support' ) ) {
    ...
    add_image_size( 'thumb-post', 678, 500, true ); // Custom Thumbnail Size call using the_post_thumbnail('thumb-post');
    add_image_size( 'thumb-podcast', 186, 188, true ); // Custom Thumbnail Size call using the_post_thumbnail('thumb-podcast');
